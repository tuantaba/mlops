...
@dsl.pipeline(name="tuantb-pipeline", description="this is description")
def pipeline():
    # TODO: Load and preprocess datai
    data_process_data = process_data()
    texts = data_process_data.outputs["texts"]
    labels = data_process_data.outputs["labels"]
